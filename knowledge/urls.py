...
urlpatterns = [
    ...
    url(r'^knowledge/remove/$', knowledge.views.removeKnowledgeAj, name='remove-knowledge'),
    url(r'^knowledge/(?P<knowledge_id>\d+)/$', knowledge.views.showKnowledge, name='show-knowledge'),
    url(r'^knowledge/(?P<knowledge_id>\d+)/edit$', knowledge.views.showEditKnowledge, name='edit-knowledge'),
    url(r'^knowledge/(?P<knowledge_id>\d+)/rate', knowledge.views.rateKnowledgeAJ, name='rate-knowledge'),
